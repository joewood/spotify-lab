...
call python auto-list.py update-cache --playlist "Noise"  --playlist "Holiday Songs" --playlist "December Songs" --playlist "Variations on a Christmas Theme"
...
call python auto-list.py playlist "December This Year" --include "December Songs" --added-after=T-450 --include "Holiday Songs" --include-holidays --exclude-noise 
