...
python auto-list.py playlist "December This Year" --include "December Songs" --added-after=T-450 --include "Holiday Songs" --include-holidays --exclude-noise 
python auto-list.py playlist "December New" --include "December Songs" --released-after=T-450 --include "Holiday Songs"  --include-holidays --exclude-noise 
