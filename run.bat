...
call python auto-list.py playlist "Movies Energetic" --genre "orchestral soundtrack" --genre "soundtrack"  --genre "scorecore" --genre "theme"  --min-energy 0.4 --update-cache
...
call python auto-list.py playlist "Classical Quiet" --genre "orchestra" --genre "orchestral"  --genre "symphony" --genre "post-romantic era" --genre "classical" --genre "symfonicky orchestr" --genre "opera" --genre "baroque"  --max-loudness -25
...
call python auto-list.py playlist "Dinner Party" --min-acousticness 0.8 --max-energy 0.5 --max-instrumentalness 0.7 --max-duration_ms 3600000 --released-after "1980-01-01" ^
    ...
    --exclude-genre "guitarra clasica" --exclude-genre "classical guitar" ^
    --exclude-genre "british modern classical" --exclude-genre "german romanticism" --exclude-genre "russian romanticism" --exclude-genre "ukrainian classical"
call python auto-list.py playlist "No Distraction"  --min-instrumentalness 0.85 --min-danceability 0.5 --max-energy 0.8 
...
call python auto-list.py playlist "Depeche Mode" --artist "Depeche Mode" --artist-like "Depeche Mode"
...
call python auto-list.py playlist "Blur vs Oasis" --artist "Oasis" --artist "Noel Gallagher" --artist "Liam Gallagher" --artist "Beady Eye" --artist "Noel Gallagher's High Flying Birds"  --artist "Blur" --artist "Gorillaz" --artist-like "Oasis"
